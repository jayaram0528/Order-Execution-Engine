...
describe('Worker Event Handlers', () => {
  ...
  it('should trigger failed event when job fails', async () => {
    ...
    // ✅ FIXED: Force job to fail by making database update fail consistently
  ...
  it('should handle graceful shutdown', async () => {
    // Test that worker and queue can close gracefully
  ...
  // ✅ NEW: Additional tests for better coverage

  it('should handle stalled jobs', async () => {
    // This test covers the stalled event handler (line 185)
  ...
  it('should handle worker errors', async () => {
    // This covers the error event handler (line 181)
  ...
  it('should broadcast retry status with correct delay', async () => {
    // This covers lines 126-138 (retry status messages)
  ...
  it('should log progress events', async () => {
    // This covers the progress event handler (line 193)
